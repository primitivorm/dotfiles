...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
	(shut-up rainbow-identifiers rainbow-blocks minimap idle-highlight-mode hl-sexp full-ack etags-table etags-select ctags-update clang-format auto-auto-indent ac-clang))))
(custom-set-faces
